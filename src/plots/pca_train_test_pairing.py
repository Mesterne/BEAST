...
def pca_plot_train_test_pairing_with_predictions(mts_pca_df, dataset_row, predictions, prediction_sample):
    # Extract the necessary indices
...
dataset_row = test_dataset.loc[index]
dataset_row
# Call the function with predictions dataframe
plot_sample(mts_pca_df, dataset_row, predictions, prediction)
