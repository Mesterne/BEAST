...
def plot_error_vs_correlation_for_each_feature(mse_values_for_each_feature, correlation_matrix):
    """
    ...
    groups = {
        'seasonal_strength': ['grid-load_seasonal-strength', 'grid-loss_seasonal-strength', 'grid-temp_seasonal-strength'],
        'trend_linearity': ['grid-load_trend-linearity', 'grid-loss_trend-linearity', 'grid-temp_trend-linearity'],
        'trend_slope': ['grid-load_trend-slope', 'grid-loss_trend-slope', 'grid-temp_trend-slope'],
        'trend_strength': ['grid-load_trend-strength', 'grid-loss_trend-strength', 'grid-temp_trend-strength']
    }
    ...
    for group, columns in groups.items():
        for i, column in enumerate(columns):
            ...
            y_vals_mse.append(mse_values_for_each_feature[column])  # MSE values for each column
